...
// 2. If argc == 2: assumes a single quoted string of numbers → splits and converts them.
// 3. If argc > 2: processes each argument individually and converts them to integers.
